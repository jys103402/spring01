...
public class CityMapperTests {
	...
	@Test
	public void test01_selectAlllWithCountry(){
		List<City> city = mapper.selectAllWithCoutnry();
	...
	public void test03_selectById(){
		City city = mapper.selectById(10000000);
	...
	public void test03_selectByIdWithCountry(){
		City city = mapper.selectByIdWithCountry(24008);
